class ProvidedQueries {
  ...
  static fetch_provide_data = `
    select sm_models.sm_num, stf_models.id as stf_id, sm_models.sm_material_name as material_name, provided_models.provided_amount as amount, sm_models.sm_material_unit as unit, 
